Ext.define('VisLeader.controller.free.FreeController', {
    extend: 'Ext.app.Controller',
	requires:[
		'VisLeader.view.free.FreeCheck',
		'VisLeader.view.free.FreeDetail',
		'VisLeader.view.free.FreeExecute',
		'VisLeader.util.MyUtil'
	],
	config: {
	...
	freeviewToDetail: function(record){
		console.log(record);
		pageInit('freeDetail',null,'VisLeader.view.free.FreeDetail');
		//相关金额初始化
		var free_budget = 0;
				...
				callback: function(err,flag,args) {
					...
					if(err == null){
						if(flag=="true"|| flag=='true'||flag==true){
							...
							Ext.Viewport.add(Ext.create('VisLeader.view.free.FreeApplication'));
	...
	freeExecute: function(){
		pageInit('freeExecute','sharepicstoreb','VisLeader.view.free.FreeExecute');
