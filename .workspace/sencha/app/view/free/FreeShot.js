Ext.define('VisLeader.view.free.FreeShot', {
	...
	requires: [
		...
		'Ext.field.Number',
		'Ext.field.TextArea',
		'VisLeader.view.free.FreePanel',
		'VisLeader.model.free.ImagePublishVO',
		'VisLeader.util.GloableVariable',
		'VisLeader.util.UploadFile',
		'VisLeader.util.UploadeUtils'
	],
	xtype:'freeShot',
						...
						itemtap: function(view, index, target, record, e, eOpts) {
							if (GloableVariable.isTap) {
								...
								if (record.get('id') == '000000000000001') {
									...
									if(!view) {
										view = Ext.create('VisLeader.view.free.FreePanel');
									}
