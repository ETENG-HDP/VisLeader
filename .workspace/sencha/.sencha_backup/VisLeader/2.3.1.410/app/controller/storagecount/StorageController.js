Ext.define('VisLeader.controller.storagecount.StorageController', {
    extend: 'ETFramework.app.Controller',
  requires: [
    'VisLeader.util.StoreRecipe',
    'VisLeader.view.storagecount.SelectRecipePage',
    'VisLeader.view.storagecount.ProductionStore'
  ],
  config: {
  	control: {
  		'viewport': {
