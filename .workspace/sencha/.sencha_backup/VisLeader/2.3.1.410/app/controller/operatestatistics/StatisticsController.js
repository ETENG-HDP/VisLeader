Ext.define('VisLeader.controller.operatestatistics.StatisticsController', {
    extend: 'ETFramework.app.Controller',
  requires: [
    'VisLeader.view.operatestatistics.KanDanLiang',
    'VisLeader.util.Backend',
    'VisLeader.util.Toast',
    'VisLeader.util.GetExceptNumber',
    'VisLeader.util.FallsRefresh',
    'VisLeader.util.ColorProduct'
  ],
  config: {
  	control: {
  	  'viewport': {
