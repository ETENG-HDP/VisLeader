Ext.define('VisLeader.view.free.FreePanel', {
    extend: 'Ext.Panel',
	alias: 'widget.freePanel',
	config: {
	    modal: true,
	    hideOnMaskTap: true,
	    centered: true,
	    ...
	    items: [{
	    	...
	    	listeners: {
	    		tap: function() {
	    			...
	    			var dataview = Ext.Viewport.query('dataview[name = freeApplicationDisplay]')[0];
	    ...
	    ,{
	    	...
	    	listeners: {
	    		tap: function() {
	    			...
	    			var dataview = Ext.Viewport.query('dataview[name = freeApplicationDisplay]')[0];
	    			var view = Ext.Viewport.query('freePanel')[0];
	    			UploadFile.selectPicture(store,component,dataview,90,false);
	    			if(view){
	    				view.destroy();
	    			}
	    		}
