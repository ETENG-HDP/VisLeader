module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    clean: [CORDOVA_DIR + '/www/*', WORKSPACE_DIR + '/build/*', APP_DIR + '/app/*', APP_DIR+'/resources/sass/.sass-cache/*'],
    copy: {
      splash:{
        expand: true,
        cwd: WORKSPACE_DIR + '/sencha/resources/icons/',
        src: 'splash.png',
        dest: CORDOVA_DIR + '/platforms/android/res/drawable/'
      },
      app: {
      	expand: true,
