...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.local_zh_cn.Picker": "app/util/UtilToast.js",
  "Ext.zh.DatePicker": "app/util/UtilToast.js",
  "Ext.zh.List": "app/util/UtilToast.js",
  "Ext.zh.plugin.ListPaging": "app/util/UtilToast.js"
});
Ext.ClassManager.addNameAlternateMappings({
  "BcpBoss.controller.Router": [],
  "BcpBoss.controller.SignUpController": [],
  "BcpBoss.controller.UpdateController": [],
  "BcpBoss.controller.free.FreeController": [],
  "BcpBoss.controller.more.MoreAppController": [],
  "BcpBoss.controller.native.Main": [],
  "BcpBoss.controller.operatestatistics.StatisticsController": [],
  "BcpBoss.controller.ranking.RankingController": [],
  "BcpBoss.controller.recipesales.RecipeSalesController": [],
  "BcpBoss.controller.showwork.ShowWorkController": [],
  "BcpBoss.controller.storagecount.StorageController": [],
  "BcpBoss.model.RecentSellModel": [],
  "BcpBoss.model.RegionModel": [],
  "BcpBoss.model.SellNumber": [],
  "BcpBoss.model.ShowWorkVO": [],
  "BcpBoss.model.feature.FeatureModel": [],
  "BcpBoss.model.free.FreeVO": [],
  "BcpBoss.model.free.ImagePublishVO": [],
  "BcpBoss.model.more.MoreAppVO": [],
  "BcpBoss.model.showwork.ShowWorkVO": [],
  "BcpBoss.model.storagecount.StorageModel": [],
  "BcpBoss.profile.Main": [],
  "BcpBoss.store.MoreAppStore": [],
  "BcpBoss.store.RecipeProduceStore": [],
  "BcpBoss.store.StorageStore": [],
  "BcpBoss.store.free.FreeStore": [],
  "BcpBoss.store.showwork.WorkDetailsStore": [],
  "BcpBoss.util.Backend": [],
  "BcpBoss.util.ColorProduct": [
    "ColorProduct"
  ],
  "BcpBoss.util.Config": [
    "bcpConfig"
  ],
  "BcpBoss.util.CssTransition": [],
  "BcpBoss.util.FallsRefresh": [],
  "BcpBoss.util.GetExceptNumber": [
    "GetExceptNumber"
  ],
  "BcpBoss.util.GloableVariable": [
    "GloableVariable"
  ],
  "BcpBoss.util.MyUtil": [
    "MyUtil"
  ...
  "BcpBoss.util.StoreRecipe": [
    "StoreRecipe"
  ],
  "BcpBoss.util.Toast": [
    "Toast"
  ],
  "BcpBoss.util.UploadFile": [
    "UploadFile"
  ],
  "BcpBoss.util.UploadeUtils": [
    "UploadeUtils"
  ],
  "BcpBoss.util.Util": [
    "ViewSwitch"
  ],
  "BcpBoss.util.UtilToast": [
    "utils"
  ],
  "BcpBoss.view.Main": [],
  "BcpBoss.view.PhotoView": [],
  "BcpBoss.view.TestView": [],
  "BcpBoss.view.UpdateUrl": [],
  "BcpBoss.view.account.SignIn": [],
  "BcpBoss.view.account.SignUp": [],
  "BcpBoss.view.common.BackButton": [],
  "BcpBoss.view.free.ExecutePanel": [],
  "BcpBoss.view.free.FreeApplication": [
    "freeApplication"
  ],
  "BcpBoss.view.free.FreeCheck": [],
  "BcpBoss.view.free.FreeDetail": [],
  "BcpBoss.view.free.FreeExecute": [],
  "BcpBoss.view.free.FreePanel": [],
  "BcpBoss.view.free.FreeShot": [
    "freeShot"
  ],
  "BcpBoss.view.more.MoreApp": [],
  "BcpBoss.view.operatestatistics.CompleteRate": [],
  "BcpBoss.view.operatestatistics.DetailInfo": [],
  "BcpBoss.view.operatestatistics.KanDanLiang": [],
  "BcpBoss.view.operatestatistics.RecentSell": [],
  "BcpBoss.view.operatestatistics.SellCompair": [],
  "BcpBoss.view.operatestatistics.Statistics": [],
  "BcpBoss.view.rankingcount.RankingItem": [],
  "BcpBoss.view.recipesales.ProductSaleOrder": [],
  "BcpBoss.view.recipesales.RecipeSalePie": [],
  "BcpBoss.view.recipesales.RecipeSalesOrder": [],
  "BcpBoss.view.recipesales.SaleOrder": [],
  "BcpBoss.view.showwork.WorkDetailsView": [],
  "BcpBoss.view.storagecount.CurrentStoreView": [],
  "BcpBoss.view.storagecount.ProductionStore": [],
  "BcpBoss.view.storagecount.SelectRecipePage": [],
  "ETFramework.Backend": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "BcpBoss.view.recipesales.ProductSaleOrder": [
    "widget.saledetailorder"
  ],
  "BcpBoss.view.recipesales.RecipeSalePie": [
    "widget.recipepiechart"
  ],
  "BcpBoss.view.recipesales.RecipeSalesOrder": [
    "widget.recipesaleorder"
  ],
  "BcpBoss.view.recipesales.SaleOrder": [
    "widget.saleorder"
  ],
  "BcpBoss.view.showwork.WorkDetailsView": [
    "widget.workDetailsView"
  ],
  "BcpBoss.view.storagecount.CurrentStoreView": [
    "widget.currentstoreview"
  ],
  "BcpBoss.view.storagecount.ProductionStore": [
    "widget.productionstore"
  ],
  "BcpBoss.view.storagecount.SelectRecipePage": [
    "widget.selectrecipe"
  ],
